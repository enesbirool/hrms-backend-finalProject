...
public class JHPKPSPublicSoap
{
    ...
    public JHPKPSPublicSoap(){}

    public JHPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JHPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JHPExtendedSoapSerializationEnvelope envelope= new JHPExtendedSoapSerializationEnvelope(JHPExtendedSoapSerializationEnvelope.VER11);

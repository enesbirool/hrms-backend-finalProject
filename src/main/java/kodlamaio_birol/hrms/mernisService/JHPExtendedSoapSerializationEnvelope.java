...
public class JHPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JHPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JHPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JHPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JHPDateTimeConverter dateTimeConverter = new JHPStandardDateTimeConverter();

    public JHPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JHPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JHPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JHPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JHPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JHPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
